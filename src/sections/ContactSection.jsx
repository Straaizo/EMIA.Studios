...
/**
 * Sección de contacto (#contacto), antes del footer.
 * Antes existía un CTASection separado justo arriba (banner con título +
 * botón que solo hacía scroll hasta acá) — se fusionó con este formulario:
 * las dos secciones no aportaban nada distinto entre sí, y esa costura se
 * notaba en mobile sin importar cuánto se suavizara la transición entre
 * ambas. La solución real era no tener dos secciones ahí.
 */
export default function ContactSection() {
  ...
  return (
    ...
    <section id="contacto" ref={ref} className="relative overflow-hidden bg-bg py-20 sm:py-28 lg:py-32">
      <GlowOrb color="#2dd9f5" className="-left-16 top-16 h-56 w-56 sm:left-[-6rem] sm:top-24 sm:h-96 sm:w-96" />
      <GlowOrb
        color="#ff3dcb"
        opacityMultiplier={0.6}
        className="-right-16 top-16 h-56 w-56 sm:right-[-6rem] sm:top-24 sm:h-96 sm:w-96"
      />
      ...
      <div className="relative mx-auto max-w-2xl px-6 text-center md:px-10">
        ...
        >
          ...
          <h2 className="mt-4 font-display text-3xl font-semibold tracking-tight text-text sm:text-4xl lg:text-5xl">
            ¿Listo para evolucionar <span className="text-gradient">tu flujo de trabajo</span>?
          </h2>
